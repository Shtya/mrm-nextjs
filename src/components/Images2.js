...
import LED8 from "../assets/gallery/3.LED-inddor/LED Signage 600x600-08.webp"
...
import Building8 from "../assets/gallery/8.Building/Building Wrap 600x600-08.webp"
...
import OutDoor7 from "../assets/gallery/9.OutdoorLed/Outdoor LED 600x600-07.webp"
import OutDoor8 from "../assets/gallery/9.OutdoorLed/Outdoor LED 600x600-08.webp"
...
import Logo7 from "../assets/gallery/branding/Logo-Design/Logo Design Gallery-07.webp"
import Logo8 from "../assets/gallery/branding/Logo-Design/Logo Design Gallery-08.webp"
...
import giftItem8 from "../assets/gallery/gifts/Gift-Item/Gift Items 600x600-08.webp"
...
import Tropihes7 from "../assets/gallery/gifts/Tropiehs/Trophies 600x600-07.webp"
import Tropihes8 from "../assets/gallery/gifts/Tropiehs/Trophies 600x600-08.webp"
...
import Real1 from '../assets/gallery/photography/reallState/Real-Estate-01.webp'
import Real2 from '../assets/gallery/photography/reallState/Real-Estate-02.webp'
import Real3 from '../assets/gallery/photography/reallState/Real-Estate-03.webp'
import Real4 from '../assets/gallery/photography/reallState/Real-Estate-04.webp'
import Real5 from '../assets/gallery/photography/reallState/Real-Estate-05.webp'
import Real6 from '../assets/gallery/photography/reallState/Real-Estate-06.webp'
import Real7 from '../assets/gallery/photography/reallState/Real-Estate-07.webp'
import Real8 from '../assets/gallery/photography/reallState/Real-Estate-08.webp'

import Fashion1 from "../assets/gallery/photography/Fashion/Fashion-01.webp"
import Fashion2 from "../assets/gallery/photography/Fashion/Fashion-02.webp"
import Fashion3 from "../assets/gallery/photography/Fashion/Fashion-03.webp"
import Fashion4 from "../assets/gallery/photography/Fashion/Fashion-04.webp"
import Fashion5 from "../assets/gallery/photography/Fashion/Fashion-05.webp"
import Fashion6 from "../assets/gallery/photography/Fashion/Fashion-06.webp"
import Fashion7 from "../assets/gallery/photography/Fashion/Fashion-07.webp"
import Fashion8 from "../assets/gallery/photography/Fashion/Fashion-08.webp"


import Events1 from "../assets/gallery/photography/Events/Events-01.webp"
import Events2 from "../assets/gallery/photography/Events/Events-02.webp"
import Events3 from "../assets/gallery/photography/Events/Events-03.webp"
import Events4 from "../assets/gallery/photography/Events/Events-04.webp"
import Events5 from "../assets/gallery/photography/Events/Events-05.webp"
import Events6 from "../assets/gallery/photography/Events/Events-06.webp"
import Events7 from "../assets/gallery/photography/Events/Events-07.webp"
import Events8 from "../assets/gallery/photography/Events/Events-08.webp"
...
export const ImageGalleryHome2 = [
  {name:"Signages all" , images: [
    {img:  Sign1   },
    {img:  Sign2   }   
  ]},
  {name:"Signages all" , images: [
  ...
  {name:"Displaystands all" , images: [
    {img:  DisplayStand1 , alt:"Modern pharmacy display stand with illuminated shelving  "   },
    {img:  DisplayStand2 , alt:"Elegant jewelry store interior with display cases  "     }   
  ]},
  {name:"Displaystands all" , images: [
    {img:  DisplayStand3 , alt:"contemporary store display stand design   "   },
    {img:  DisplayStand4 , alt:"cosmetic display stand  with greenery accents  "     }   
  ]},
  {name:"Displaystands all" , images: [
    {img:  DisplayStand5 , alt:" Display stand makeup shelves with bold imagery.  "   },
    {img:  DisplayStand6 , alt:"Stylish beauty product display stand in an elegant store  "     }   
  ]},

  {name:"Exhibition all" , images: [
    {img:  Exhibition1 , alt:"Modern exhibit booth with striking black and gold design  "   },
    {img:  Exhibition2 , alt:"Chic jewelry Exhibition stand with luxurious white decor.  "     }   
  ]},
  {name:"Exhibition all" , images: [
    {img:  Exhibition3 , alt:"Sophisticated boutique Exhibition stand with curved wooden details  "   },
    {img:  Exhibition4 , alt:"Futuristic exhibition space with white and blue lighting.  "     }   
  ]},
  {name:"Exhibition all" , images: [
    {img:  Exhibition5 , alt:"Elegant exhibition stand with flowing golden accents  "   },
    {img:  Exhibition6 , alt:"Opulent event booth with overhead golden chandelier  "     }   
  ]},
  {name:"Exhibition all" , images: [
    {img:  Exhibition7 , alt:"Contemporary lounge area within a Exhibition stand.  "   },
    {img:  Exhibition8 , alt:"Innovative tech exhibition stand with circular theme  "     }   
  ]},

  {name:"branding all" , images: [
    {img:   Logo1      , alt:"Phone with social media event promotion  " },
    {img:  Packaging1  , alt:"Professionals from different industries  " }   
  ]},
  {name:"branding all" , images: [
    {img:  SocialMedia1  , alt:"Branded-vehicle-showcase"   },
    {img:  stationery1     }   
  ]},
  {name:"branding all" , images: [
    {img:  uniform1     },
  ...
  {name:"photography all" , images: [
    {img:  Photography1 , alt:"Interior photography of a cozy, well-lit restaurant  "   },
    {img:  Photography2 , alt:"Event photography of a speaker engaging a large audience  "     }   
  ]},
  {name:"photography all" , images: [
    {img:  Photography3 , alt:"photography of a modern building at sunset  "   },
    {img:  Photography4 , alt:"photography of an opulent home exterior  "     }   
  ]},
  {name:"photography all" , images: [
    {img:  Photography5 , alt:"Fashion photography of a woman in chic winter attire  "   },
    {img:  Photography6 , alt:"Portrait photography of a professional man  "     }   
  ]},
  {name:"photography all" , images: [
    {img:  Photography7 , alt:"Food photography of an artistic pasta dish  "   },
    {img:  Photography8 , alt:"Product photography of an exquisite perfume bottle with splashes  "     }   
  ]},
  

  {name:"Web all" , images: [
    {img:  webDesign1 , alt:"Furniture website display on laptop and phone  "   },
    {img:  webDesign2 , alt:"Houseplant care Website on laptop and mobile  "     }   
  ]},
  {name:"Web all" , images: [
    {img:  webDesign3 , alt:"Creative website on laptop and phone  "   },
    {img:  webDesign4 , alt:"Beauty services website on multiple devices  "     }   
  ]},
  {name:"Web all" , images: [
    {img:  webDesign5 , alt:"Creative portfolio website on laptop and phone  "   },
    {img:  webDesign6 , alt:"Laptop and phone showcasing coffee website  "     }   
  ]},
  
  
  
  {name:"Gifts all" , images: [
    {img:  giftItem1   },
    {img:  giftItem2   }   
  ]},
  {name:"Gifts all" , images: [
    {img:  giftItem3   },
    {img:  Tropihes1  , alt:"Golden trophy stars sparkle" , titleImg:"Classic Gold Trophy"    }   
  ]},
  {name:"Gifts all" , images: [
    {img:  Tropihes2  , alt:"Sparkling crystall award" , titleImg:"crystal flame trophy"  },
    {img:  Tropihes3  , alt:"Contemporary glass trophy" , titleImg:"Modern Achievement trophy"    }   
  ]},
...
export const ImageGalleryGifts = [
  ...
  {name:"trophies all" , images: [
    {img:  Tropihes7 , type:`trophies all`  , alt:"set of winner medals " , titleImg:" champion medals trio"  }  ,
    {img:  Tropihes8 , type:`trophies all`  , alt:"Shiny gold medal ribbon" , titleImg:"Golden victory medal"  }  ,
  ]},

  
  {name:"gift-Item all" , images: [
    {img:  giftItem1 , alt:"" }  ,
    {img:  giftItem2 , alt:"" }  ,
  ]},
  {name:"gift-Item all" , images: [
  ...
  {name:"Corporate-gifts all" , images: [
    {img:  giftItem5 , alt:"" }  ,
    {img:  giftItem6 , alt:"" }  ,
  ]},
  {name:"Corporate-gifts all" , images: [
...
export const  ImageGalleryBranding = [
  ...
  {name:"Socialmedia all" , images: [
    {img: SocialMedia1  , titleImg:"Engaging-Online-Branding" , alt:"Phone with social media event promotion  "}  ,
    {img: SocialMedia2  , titleImg:"Engaging-Online-Branding" , alt:"Phone with social media event promotion  "}  ,
  ]},
  {name:"Socialmedia all" , images: [
    {img: SocialMedia3  , titleImg:"Engaging-Online-Branding" , alt:"Phone with social media event promotion  "}  ,
    {img: SocialMedia4  , titleImg:"Engaging-Online-Branding" , alt:"Phone with social media event promotion  "}  ,
  ]},
  {name:"Socialmedia all" , images: [
    {img: SocialMedia5  , titleImg:"Engaging-Online-Branding" , alt:"Phone with social media event promotion  "}  ,
    {img: SocialMedia6  , titleImg:"Engaging-Online-Branding" , alt:"Phone with social media event promotion  "}  ,
  ]},
  {name:"Socialmedia all" , images: [
    {img: SocialMedia7  , titleImg:"Engaging-Online-Branding" , alt:"Phone with social media event promotion  "}  ,
    {img: SocialMedia8  , titleImg:"Engaging-Online-Branding" , alt:"Phone with social media event promotion  "}  ,
  ]},



  {name:"packaging all" , images: [
    {img: Packaging1 ,  alt:"" }  ,
    {img: Packaging2 ,  alt:"" }  ,
  ]},
  {name:"packaging all" , images: [
  ...
  {name:"vehicles all" , images: [
    {img: vehicles1 ,  alt :"Vehicle-Branding-Fleet", titleImg:"Branded-vehicle-showcase"}  ,
    {img: vehicles2 ,  alt :"Vehicle-Branding-Fleet", titleImg:"Branded-vehicle-showcase"}  ,
  ]},
  {name:"vehicles all" , images: [
    {img: vehicles3 ,  alt :"Vehicle-Branding-Fleet", titleImg:"Branded-vehicle-showcase"}  ,
    {img: vehicles4 ,  alt :"Vehicle-Branding-Fleet", titleImg:"Branded-vehicle-showcase"}  ,
  ]},
  {name:"vehicles all" , images: [
    {img: vehicles5 ,  alt :"Vehicle-Branding-Fleet", titleImg:"Branded-vehicle-showcase"}  ,
    {img: vehicles6 ,  alt :"Vehicle-Branding-Fleet", titleImg:"Branded-vehicle-showcase"}  ,
  ]},
  {name:"vehicles all" , images: [
    {img: vehicles7 ,  alt :"Vehicle-Branding-Fleet", titleImg:"Branded-vehicle-showcase"}  ,
    {img: vehicles8 ,  alt :"Vehicle-Branding-Fleet", titleImg:"Branded-vehicle-showcase"}  ,
  ]},



  {name:"uniform all" , images: [
    {img: uniform1 , alt:"Professionals from different industries" }  ,
    {img: uniform2 , alt:"Professionals from different industries" }  ,
  ]},
  {name:"uniform all" , images: [
    {img: uniform3 , alt:"Professionals from different industries" }  ,
    {img: uniform4 , alt:"Professionals from different industries" }  ,
  ]},
  {name:"uniform all" , images: [
    {img: uniform5 , alt:"Professionals from different industries" }  ,
    {img: uniform6 , alt:"Professionals from different industries" }  ,
  ]},
  {name:"uniform all" , images: [
    {img: uniform7 , alt:"Professionals from different industries" }  ,
    {img: uniform8 , alt:"Professionals from different industries" }  ,
  ]},
  


  {name:"stationery all" , images: [
